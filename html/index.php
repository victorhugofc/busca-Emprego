...
<div class="a p-0 mb-0" style="position:absolute;top:0px;left:0px; width: 100%; background-color:#f0f2f4;">
     <p class="" style= > </p>
         <div class="menu">
           <div class="logo">
             <a class="nav-link" href="..\html\index.php"><img src="..\img\logo.png" alt="" width="200" height="75" ></a>
           </div>
               <ul class="nav justify-content-end">
                 <li class="nav-item">
                   <a class="nav-link active" href="index.php"><img src="https://img.icons8.com/ios/25/000000/home.png"> Home</a>
                 </li>
           <li class="nav-item">
             <a class="nav-link active" href="cadastrar.php"><img src="https://img.icons8.com/ios/25/000000/add-user-group-man-man.png"> Cadastrar</a>
           </li>
           <li class="nav-item">
